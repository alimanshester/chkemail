...
USAGE: python ./chkemail.py [OPTIONS...]
...
| python chkemail.py -s alimanshester@gmail.com

|--------

| python chkemail.py -m basel1@gmail.com,basel2@gmail.com,Omar@hotmail.com

|--------

| python chkemail.py -f emails.txt
